...
function doSearch(){var q=document.getElementById('search-input');if(q&&q.value.trim())window.location.href='/latest-jobs.html?q='+encodeURIComponent(q.value.trim());}
...
function initFooter(){
  ...
  +'<div class="footer__links"><a href="/latest-jobs.html">Latest Jobs</a><a href="/results.html">Results</a><a href="/admit-cards.html">Admit Cards</a></div></div>'
  +'<div><h3 class="footer__title">Tools</h3>'
  +'<div class="footer__links"><a href="/eligibility-calculator.html">Eligibility Calculator</a><a href="/study-planner.html">Study Planner</a><a href="/previous-papers.html">Previous Papers</a><a href="/syllabus.html">Syllabus</a><a href="/cut-off-marks.html">Cut-off Marks</a></div></div></div>'
